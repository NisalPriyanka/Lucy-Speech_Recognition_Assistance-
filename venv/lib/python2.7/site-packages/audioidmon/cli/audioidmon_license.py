...
parser = argparse.ArgumentParser(prog='audioidmon_license', description='Return license status info. The stdout is displayed in JSON.')
...
def main():
    ...
    if args.verbose:
        print "Get license status from audioid monitor service:"
