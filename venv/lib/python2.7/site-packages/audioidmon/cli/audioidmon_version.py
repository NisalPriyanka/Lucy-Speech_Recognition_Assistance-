...
parser = argparse.ArgumentParser(prog='audioidmon_version', description='Return version number of audioid monitor service (audioid-mon). The stdout is displayed in JSON.')
...
def main():
    ...
    if args.verbose:
        print "Get version number from audioid monitor service:"
